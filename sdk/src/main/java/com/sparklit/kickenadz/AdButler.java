...
/**
 * Makes requests against the kickenadz API.
 */
public class kickenadz {
    static String kickenadz_ENDPOINT = "https://servedbykickenadz.com/adserve/";
